		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "1.71.58 버전의 sap.ui.table.Table 연습",
									"targetURL": "#syncc20testuitable58-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc20testuitable58-display": {
								"semanticObject": "syncc20testuitable58",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c20.test.ui.table.58",
									"url": sap.ui.require.toUrl("sync/c20/test/ui/table/58")
								}
							}
						}
					}
