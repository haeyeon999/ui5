		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ui5C20homework1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5C20homework1review-display": {
								"semanticObject": "ui5C20homework1review",
								"action": "display",
								"description": "ui5 주간실습과제",
								"title": "UI5 - Table &amp; Fragment 활용하기",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.C20.homework1.review",
									"url": sap.ui.require.toUrl("ui5/C20/homework1/review")
								}
							}
						}
					}
