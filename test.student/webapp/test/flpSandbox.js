		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 관리 프로그램",
									"targetURL": "#syncc20teststudent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc20teststudent-display": {
								"semanticObject": "syncc20teststudent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c20.test.student",
									"url": sap.ui.require.toUrl("sync/c20/test/student")
								}
							}
						}
					}
