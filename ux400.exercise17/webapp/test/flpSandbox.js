		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create an SAPUI5 Component (optional)",
									"targetURL": "#ux400exercise17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ux400exercise17-display": {
								"semanticObject": "ux400exercise17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux400.exercise17",
									"url": sap.ui.require.toUrl("ux400/exercise17")
								}
							}
						}
					}
