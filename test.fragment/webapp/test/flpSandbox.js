		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment 연습",
									"targetURL": "#syncc20testfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc20testfragment-display": {
								"semanticObject": "syncc20testfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c20.test.fragment",
									"url": sap.ui.require.toUrl("sync/c20/test/fragment")
								}
							}
						}
					}
