		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#syncc20testjsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc20testjsonmodel-display": {
								"semanticObject": "syncc20testjsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c20.test.jsonmodel",
									"url": sap.ui.require.toUrl("sync/c20/test/jsonmodel")
								}
							}
						}
					}
