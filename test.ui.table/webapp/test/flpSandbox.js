		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc20testuitable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc20testuitable-display": {
								"semanticObject": "syncc20testuitable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c20.test.ui.table",
									"url": sap.ui.require.toUrl("sync/c20/test/ui/table")
								}
							}
						}
					}
